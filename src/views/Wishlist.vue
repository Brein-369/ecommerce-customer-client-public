  ...
  <div class="wishlist">
    ...
    <div class="container">
      ...
      <div class="col-md-12 mb-3">
        <h4>List of All Items on Wishlist</h4>
      </div>
            ...
            <table class="table table-shopping">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Remove Wishlist</th>
                  <th></th>
                </tr>
              </thead>
              <tbody>
                <WishlistItem v-for="eachWishlist in allWishlist" :key="eachWishlist.id"
                :eachWishlist = "eachWishlist"
                ></WishlistItem>
              </tbody>
            </table>
          </div>
...
export default {
  ...
  methods: {
    getAllWishlist () {
      this.$store.dispatch('getAllWishlist')
    }
  },
  created () {
    this.getAllWishlist()
